...
public class ModVariables {
    ...
    public static void init(FMLCommonSetupEvent event) {
        EnchantifyMod.addNetworkMessage(PlayerVariablesSyncMessage.class, PlayerVariablesSyncMessage::buffer, PlayerVariablesSyncMessage::new, PlayerVariablesSyncMessage::handler);
    }
    ...
    public static class EventBusVariableHandlers {
        ...
        public static void clonePlayer(PlayerEvent.Clone event) {
            ...
            if (!event.isWasDeath()) {
                ...
                clone.strafeRight = original.strafeRight;
                clone.strafeBack = original.strafeBack;
                clone.strafeCooldown = original.strafeCooldown;
            }
        }
    }
    ...
    public static class PlayerVariables {
        ...
        public boolean strafeBack = false;
        public boolean strafeCooldown = false;

        public void syncPlayerVariables(Entity entity) {
            if (entity instanceof ServerPlayer serverPlayer)
                EnchantifyMod.PACKET_HANDLER.send(PacketDistributor.PLAYER.with(() -> serverPlayer), new PlayerVariablesSyncMessage(this));
        }
        ...
        public Tag writeNBT() {
            ...
            nbt.putBoolean("strafeLeft", strafeLeft);
            nbt.putBoolean("strafeRight", strafeRight);
            nbt.putBoolean("strafeBack", strafeBack);
            nbt.putBoolean("strafeCooldown", strafeCooldown);
            return nbt;
        }
        ...
        public void readNBT(Tag Tag) {
            ...
            strafeRight = nbt.getBoolean("strafeRight");
            strafeBack = nbt.getBoolean("strafeBack");
            strafeCooldown = nbt.getBoolean("strafeCooldown");
        }
    }
        ...
        public static void handler(PlayerVariablesSyncMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
            ...
            context.enqueueWork(() -> {
                if (!context.getDirection().getReceptionSide().isServer()) {
                    ...
                    variables.strafeLeft = message.data.strafeLeft;
                    variables.strafeRight = message.data.strafeRight;
                    variables.strafeBack = message.data.strafeBack;
                    variables.strafeCooldown = message.data.strafeCooldown;
                }
            });
