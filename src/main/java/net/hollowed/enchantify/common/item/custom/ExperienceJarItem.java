package net.hollowed.enchantify.common.item.custom;

import net.hollowed.enchantify.common.entity.ThrownExperienceJar;
...
public class ExperienceJarItem extends Item {
    public ExperienceJarItem(Properties p_41194_) {
        super(p_41194_);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level p_41196_, Player p_41197_, InteractionHand p_41198_) {
        ...
        if (!p_41196_.isClientSide) {
            ThrownExperienceJar thrownexperiencebottle = new ThrownExperienceJar(p_41196_, p_41197_);
